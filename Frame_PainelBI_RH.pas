...
type
  TFrameBI_RH = class(TPainel_Frame)
...
procedure TFrameBI_RH.BtnDashBoardButtonOnClick(Sender: TObject);
//Var I : Integer;
//  Achou : Boolean;
begin
...
procedure TFrameBI_RH.ConsultaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  CriaBotoesDashBoardButton;
end;

procedure TFrameBI_RH.CriaBotoesDashBoardButton;
var
  AButton: TcxButton;
  I: Integer;
begin
...
procedure TFrameBI_RH.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrameBI_RH.WREventosConsultaSQLTrataNomes(Sender: TObject;
  var ASQL: string);
begin
  inherited;
...
initialization
  RegisterFramePainel(Tag_BI_RH, TFrameBI_RH);
