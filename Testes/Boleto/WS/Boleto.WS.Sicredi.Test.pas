...
type
  TTesteBoleto_WS_Sicredi= class(TTestCase)
  public
...
procedure TTesteBoleto_WS_Sicredi.Setup;
begin
...
procedure TTesteBoleto_WS_Sicredi.TearDown;
begin
  FreeAndNil(FrmFinanceiro_Boleto);
end;

procedure TTesteBoleto_WS_Sicredi.SalvaPDFDoBoleto;
const
...
procedure TTesteBoleto_WS_Sicredi.WS_GeraRemessa;
begin
  try
    FrmFinanceiro_Boleto:= TFrmFinanceiro_Boleto.Create(nil);
    FrmFinanceiro_Boleto.Show;
...
initialization
  _RegisterTest('Boleto.Sicredi.WS', TTesteBoleto_WS_Sicredi);
