unit Boleto.Arquivo.Sicredi.Test;
...
type
  TTesteBoleto_Arquivo_Sicredi = class(TTestCase)
  public
...
procedure TTesteBoleto_Arquivo_Sicredi.Setup;
begin
...
procedure TTesteBoleto_Arquivo_Sicredi.TearDown;
begin
  FreeAndNil(FrmFinanceiro_Boleto);
end;

procedure TTesteBoleto_Arquivo_Sicredi.SalvaPDFDoBoleto;
const
...
procedure TTesteBoleto_Arquivo_Sicredi.WS_GeraRemessa;
begin
  try
    FrmFinanceiro_Boleto:= TFrmFinanceiro_Boleto.Create(nil);
    FrmFinanceiro_Boleto.Show;
...
initialization
  _RegisterTest('Boleto.Sicredi.Arquivo', TTesteBoleto_Arquivo_Sicredi);
