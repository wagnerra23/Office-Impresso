unit Boleto.Arquivo.Credisis.Test;
...
type
  TTesteBoleto_Arquivo_Credisis = class(TTestCase)
  public
...
procedure TTesteBoleto_Arquivo_Credisis.Setup;
begin
...
procedure TTesteBoleto_Arquivo_Credisis.TearDown;
begin
  FreeAndNil(FrmFinanceiro_Boleto);
end;

procedure TTesteBoleto_Arquivo_Credisis.SalvaPDFDoBoleto;
const
...
procedure TTesteBoleto_Arquivo_Credisis.WS_GeraRemessa;
begin
  try
    FrmFinanceiro_Boleto:= TFrmFinanceiro_Boleto.Create(nil);
    FrmFinanceiro_Boleto.Show;
...
initialization
  _RegisterTest('Boleto.Credisis.Arquivo', TTesteBoleto_Arquivo_Credisis);
