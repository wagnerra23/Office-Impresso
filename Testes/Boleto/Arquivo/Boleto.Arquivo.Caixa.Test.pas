unit Boleto.Arquivo.Caixa.Test;
...
type
  TTesteBoleto_Arquivo_Caixa = class(TTestCase)
  public
...
procedure TTesteBoleto_Arquivo_Caixa.Setup;
begin
...
procedure TTesteBoleto_Arquivo_Caixa.TearDown;
begin
  FreeAndNil(FrmFinanceiro_Boleto);
end;

procedure TTesteBoleto_Arquivo_Caixa.SalvaPDFDoBoleto;
const
...
procedure TTesteBoleto_Arquivo_Caixa.WS_GeraRemessa;
begin
  try
    FrmFinanceiro_Boleto:= TFrmFinanceiro_Boleto.Create(nil);
    FrmFinanceiro_Boleto.Show;
...
initialization
  _RegisterTest('Boleto.Caixa.Arquivo', TTesteBoleto_Arquivo_Caixa);
