unit Boleto.Arquivo.Santander.Test;
...
type
  TTesteBoleto_Arquivo_Santander = class(TTestCase)
  public
...
procedure TTesteBoleto_Arquivo_Santander.Setup;
begin
...
procedure TTesteBoleto_Arquivo_Santander.TearDown;
begin
  FreeAndNil(FrmFinanceiro_Boleto);
end;

procedure TTesteBoleto_Arquivo_Santander.SalvaPDFDoBoleto;
const
...
procedure TTesteBoleto_Arquivo_Santander.WS_GeraRemessa;
begin
  try
    FrmFinanceiro_Boleto:= TFrmFinanceiro_Boleto.Create(nil);
    FrmFinanceiro_Boleto.Show;
...
initialization
  _RegisterTest('Boleto.Santander.Arquivo', TTesteBoleto_Arquivo_Santander);
