unit Boleto.Arquivo.BancoBrasil.Test;
...
type
  TTesteBoleto_Arquivo_BancoBrasil = class(TTestCase)
  public
...
procedure TTesteBoleto_Arquivo_BancoBrasil.Setup;
begin
...
procedure TTesteBoleto_Arquivo_BancoBrasil.TearDown;
begin
  FreeAndNil(FrmFinanceiro_Boleto);
end;

procedure TTesteBoleto_Arquivo_BancoBrasil.SalvaPDFDoBoleto;
const
...
procedure TTesteBoleto_Arquivo_BancoBrasil.WS_GeraRemessa;
begin
  try
    FrmFinanceiro_Boleto:= TFrmFinanceiro_Boleto.Create(nil);
    FrmFinanceiro_Boleto.Show;
...
initialization
  _RegisterTest('Boleto.BancoBrasil.Arquivo', TTesteBoleto_Arquivo_BancoBrasil);
