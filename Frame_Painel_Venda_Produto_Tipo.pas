unit Frame_Painel_Venda_Produto_Tipo;
...
uses
  ...
  cxDBLookupEdit, cxDBLookupComboBox, System.ImageList, Vcl.ImgList, cxImageList, dxLayoutLookAndFeels, Frame_Painel_Mestre,
...
type
  TPainel_Venda_Produto_Tipo = class(TPainel_Mestre)
...
procedure TPainel_Venda_Produto_Tipo.InitializeFrame;
begin
  inherited;
  AtualizaTela;
end;

procedure TPainel_Venda_Produto_Tipo.CadastroCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TPainel_Venda_Produto_Tipo.TotalizadorCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TPainel_Venda_Produto_Tipo.AtualizaTela;
begin
  inherited;
  CarregaTela;
  CarregaTile;
...
procedure TPainel_Venda_Produto_Tipo.CarregaTela;
Var
  APercentual: Double;
begin
...
////////////////PERSONALIZAR O TILEBAR SUPERIOR\\\\\\\\\\\\\\\\\
  ...
  if Totalizador.FieldByname('QUANT').AsFloat > 0 then
  begin
    dxTileBar1.Items[1].Text4.IndentHorz := 65;
...
procedure TPainel_Venda_Produto_Tipo.CarregaTile;
var
...
procedure TPainel_Venda_Produto_Tipo.OnItemClick(Sender: TdxTileControlItem);
begin
...
procedure TPainel_Venda_Produto_Tipo.CarregaGrafico(ACodEmpresa :integer; ADtIncio, ADtFim :TDate);
var
...
procedure TPainel_Venda_Produto_Tipo.WREventosCadastroPreencheVariaveisImpressaoPersonalizada(
  Sender: TObject);
var
  AReport: TfrxReport;
begin
...
initialization
  RegisterFramePainel(Tag_BI_Venda_Por_Produto_Tipo, TPainel_Venda_Produto_Tipo);
end.
