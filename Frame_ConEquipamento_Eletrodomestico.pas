unit Frame_ConEquipamento_Eletrodomestico;
...
type
  TConsuEquipamento_Eletrodomestico = class(TConsuEquipamento_Mestre)
...
var
  ConsuEquipamento_Eletrodomestico: TConsuEquipamento_Eletrodomestico;
...
procedure TConsuEquipamento_Eletrodomestico.WREventosConsultaGetFiltrosConsulta(
  Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('E.TIPO = ''ELETRODOMESTICO'' ');
end;

initialization
  RegisterClass(TConsuEquipamento_Eletrodomestico);
  RegisterFrameCon(Tag_Equipamento_Eletrodomestico, TConsuEquipamento_Eletrodomestico);
