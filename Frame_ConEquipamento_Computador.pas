unit Frame_ConEquipamento_Computador;
...
type
  TConsuEquipamento_Computador = class(TConsuEquipamento_Mestre)
...
var
  ConsuEquipamento_Computador: TConsuEquipamento_Computador;
...
procedure TConsuEquipamento_Computador.WREventosConsultaGetFiltrosConsulta(
  Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('E.TIPO = ''COMPUTADOR'' ');
end;

initialization
  RegisterClass(TConsuEquipamento_Computador);
  RegisterFrameCon(Tag_Equipamento_Computador, TConsuEquipamento_Computador);
