unit Frame_ConProduto_Patrimonio;
...
type
  TConsuProduto_Patrimonio_Frame = class(TFrame_ConsuProduto_Mestre)
...
var
  ConsuProduto_Patrimonio_Frame: TConsuProduto_Patrimonio_Frame;
...
procedure TConsuProduto_Patrimonio_Frame.WREventosConsultaGetFiltrosConsulta(Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('TEM_PATRIMONIO = ''S'' ');
end;

initialization
  RegisterClass(TConsuProduto_Patrimonio_Frame);
  RegisterFrameCon(Tag_Produto_Patrimonio, TConsuProduto_Patrimonio_Frame);
