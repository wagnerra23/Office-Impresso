unit Frame_ConPessoas_Representante;
...
type
  TFrame_ConsuPessoas_Representante = class(TFrame_ConsuPessoas_Mestre)
...
var
  Frame_ConsuPessoas_Representante: TFrame_ConsuPessoas_Representante;
...
procedure TFrame_ConsuPessoas_Representante.WREventosConsultaGetFiltrosConsulta(Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('P.IS_REP = ''S'' ');
end;

initialization
  RegisterClass(TFrame_ConsuPessoas_Representante);
  RegisterFrameCon(Tag_Pessoas_Representante, TFrame_ConsuPessoas_Representante);
