...
uses
  ...
  cxDateNavigator, dxScrollbarAnnotations, cxCustomStatusKeeper, cxStatusKeeper,
  dxSkinBasic, dxSkinOffice2019Black, dxSkinOffice2019Colorful,
  dxSkinOffice2019DarkGray, dxSkinOffice2019White;

type
  TConsuConfiguracao_Regra = class(TConsuM)
...
initialization
  RegisterClass(TConsuConfiguracao_Regra);
