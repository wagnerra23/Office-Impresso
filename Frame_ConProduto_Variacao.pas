unit Frame_ConProduto_Variacao;
...
uses
  ...
  dxCustomTileControl, dxTileControl, Frame_ConProduto_Mestre, dxSkinsCore, dxSkinBasic, dxSkinOffice2019Black, dxSkinOffice2019Colorful,
  dxSkinOffice2019DarkGray, dxSkinOffice2019White, dxScrollbarAnnotations, dxActivityIndicator;

type
  TConsuProduto_Variacao_Frame = class(TFrame_ConsuProduto_Mestre)
...
var
  ConsuProduto_Variacao_Frame: TConsuProduto_Variacao_Frame;
...
procedure TConsuProduto_Variacao_Frame.WREventosConsultaGetFiltrosConsulta(Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('TEM_VARIACAO = ''S'' ');
end;

initialization
  RegisterClass(TConsuProduto_Variacao_Frame);
  RegisterFrameCon(Tag_Produto_Variacao, TConsuProduto_Variacao_Frame);
