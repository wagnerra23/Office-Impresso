...
type
  TConsuProduto_Servico_Frame = class(TFrame_ConsuProduto_Mestre)
...
var
  ConsuProduto_Servico_Frame: TConsuProduto_Servico_Frame;
...
procedure TConsuProduto_Servico_Frame.WREventosConsultaGetFiltrosConsulta(
  Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('TEM_SERVICO = ''S'' ');
end;

initialization
  RegisterClass(TConsuProduto_Servico_Frame);
  RegisterFrameCon(Tag_Produto_Servico, TConsuProduto_Servico_Frame);
