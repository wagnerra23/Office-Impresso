...
type
  TFrame_Pessoas_Todos = class(TFrame_Pessoas_Mestre)
  private
...
var
  Frame_Pessoas_Todos: TFrame_Pessoas_Todos;
...
initialization
  RegisterClass(TFrame_Pessoas_Todos);
  RegisterFrameCad(Tag_Pessoas, TFrame_Pessoas_Todos);
