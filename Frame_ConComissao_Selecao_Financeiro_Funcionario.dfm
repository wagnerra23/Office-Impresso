inherited Frame_ConsuComissao_Selecao_Financeiro_Funcionario: TFrame_ConsuComissao_Selecao_Financeiro_Funcionario
    ...
    inherited GridConsulta: TcxGrid
      inherited GridConsultaDBTableView1: TcxGridDBTableView
        ...
        object GridConsultaDBTableView1FUNCIONARIO: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'FUNCIONARIO_COMISSAO'
          Visible = False
        end
      end
    end
  ...
  inherited dxComponentPrinter1: TdxComponentPrinter
    ...
    inherited dxComponentPrinter1Link1: TdxGridReportLink
      ReportDocument.CreationDate = 44900.361338356480000000
      PixelsPerInch = 96
  ...
  inherited Consulta: TFDQuery
    SQL.Strings = (
      ...
      '       F.CODUSUARIO_CONTA, PC.DESCRICAO as PLANOCONTAS,'
        ...
        '       p.razaosocial as FUNCIONARIO_COMISSAO, P.CODIGO as CODFUN' +
        'CIONARIO_COMISSAO,'
