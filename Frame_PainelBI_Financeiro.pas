unit Frame_PainelBI_Financeiro;
...
type
  TFrameBI_Financeiro = class(TPainel_Frame)
...
var
  FrameBI_Financeiro: TFrameBI_Financeiro;
...
procedure TFrameBI_Financeiro.BtnDashBoardButtonOnClick(Sender: TObject);
//Var I : Integer;
//  Achou : Boolean;
begin
...
procedure TFrameBI_Financeiro.ConsultaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  CriaBotoesDashBoardButton;
end;

procedure TFrameBI_Financeiro.CriaBotoesDashBoardButton;
var
  AButton: TcxButton;
  I: Integer;
begin
...
procedure TFrameBI_Financeiro.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrameBI_Financeiro.WREventosConsultaSQLTrataNomes(Sender: TObject;
  var ASQL: string);
begin
  inherited;
...
initialization
  RegisterFramePainel(Tag_BI_Financeiro, TFrameBI_Financeiro);
