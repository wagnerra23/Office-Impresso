inherited Frame_ConsuComissao_Selecao_Financeiro_Agencia: TFrame_ConsuComissao_Selecao_Financeiro_Agencia
    ...
    inherited GridConsulta: TcxGrid
      inherited GridConsultaDBTableView1: TcxGridDBTableView
        ...
        object GridConsultaDBTableView1AGENCIA: TcxGridDBColumn
          Caption = 'Ag'#234'ncia Comiss'#227'o'
          DataBinding.FieldName = 'AGENCIA_COMISSAO'
          Visible = False
        end
      end
    end
  ...
  inherited dxComponentPrinter1: TdxComponentPrinter
    ...
    inherited dxComponentPrinter1Link1: TdxGridReportLink
      ReportDocument.CreationDate = 44900.359571030090000000
      PixelsPerInch = 96
  ...
  inherited Consulta: TFDQuery
    SQL.Strings = (
      ...
      '       F.CODUSUARIO_CONTA, PC.DESCRICAO as PLANOCONTAS,'
        ...
        '       p.razaosocial as AGENCIA_COMISSAO, p.CODIGO as CODAGENCIA' +
        '_COMISSAO,'
      ...
      'left join PESSOAS P on (P.codigo = V.pessoa_agencia_codigo)'
