...
uses
  ...
  cxGridCustomView, cxGrid, dxLayoutControl, cxImage, dxRibbonSkins, dxRibbonCustomizationForm, dxBar, cxBarEditItem,
...
type
  TConsuProducao_Roteiro = class(TConsuM)
...
initialization
  RegisterClass(TConsuProducao_Roteiro);
