unit Frame_ConProduto_MateriaPrima;
...
type
  TConsuProduto_MateriaPrima_Frame = class(TFrame_ConsuProduto_Mestre)
...
var
  ConsuProduto_MateriaPrima_Frame: TConsuProduto_MateriaPrima_Frame;
...
procedure TConsuProduto_MateriaPrima_Frame.WREventosConsultaGetFiltrosConsulta(
  Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('TEM_MATERIAPRIMA = ''S'' ');
end;

initialization
  RegisterClass(TConsuProduto_MateriaPrima_Frame);
  RegisterFrameCon(Tag_Produto_MateriaPrima, TConsuProduto_MateriaPrima_Frame);
