inherited ConsuProducao_Roteiro: TConsuProducao_Roteiro
  ...
  inherited dxComponentPrinter1: TdxComponentPrinter
    ...
    inherited dxComponentPrinter1Link1: TdxGridReportLink
      ReportDocument.CreationDate = 44092.297718854170000000
      PixelsPerInch = 96
  ...
  inherited Consulta: TFDQuery
    ...
    object ConsultaOBSERVACAO: TMemoField [2]
      FieldName = 'OBSERVACAO'
      Origin = 'OBSERVACAO'
      BlobType = ftMemo
    end
    object ConsultaIMAGEM: TBlobField [3]
      FieldName = 'IMAGEM'
      Origin = 'IMAGEM'
    end
