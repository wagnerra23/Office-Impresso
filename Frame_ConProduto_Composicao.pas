unit Frame_ConProduto_Composicao;
...
type
  TConsuProduto_Composicao_Frame = class(TFrame_ConsuProduto_Mestre)
...
var
  ConsuProduto_Composicao_Frame: TConsuProduto_Composicao_Frame;
...
procedure TConsuProduto_Composicao_Frame.WREventosConsultaGetFiltrosConsulta(Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('TEM_COMPOSICAO = ''S'' ');
end;

initialization
  RegisterClass(TConsuProduto_Composicao_Frame);
  RegisterFrameCon(Tag_Produto_Composicao, TConsuProduto_Composicao_Frame);
