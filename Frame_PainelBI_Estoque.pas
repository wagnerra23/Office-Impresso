...
type
  TFrameBI_Estoque = class(TPainel_Frame)
...
var
  FrameBI_Estoque: TFrameBI_Estoque;
...
procedure TFrameBI_Estoque.BtnDashBoardButtonOnClick(Sender: TObject);
//Var I : Integer;
//  Achou : Boolean;
begin
...
procedure TFrameBI_Estoque.ConsultaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  CriaBotoesDashBoardButton;
end;

procedure TFrameBI_Estoque.CriaBotoesDashBoardButton;
var
  AButton: TcxButton;
  I: Integer;
begin
...
procedure TFrameBI_Estoque.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrameBI_Estoque.WREventosConsultaSQLTrataNomes(Sender: TObject;
  var ASQL: string);
begin
  inherited;
...
initialization
  RegisterFramePainel(Tag_BI_Estoque, TFrameBI_Estoque);
