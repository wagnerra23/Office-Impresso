unit Frame_ConManifestacao_Eventos;
...
type
  TFrame_ConsuManifestacao_Eventos = class(TConsu_Frame)
  private
...
var
  Frame_ConsuManifestacao_Eventos: TFrame_ConsuManifestacao_Eventos;
...
initialization
  RegisterClass(TFrame_ConsuManifestacao_Eventos);
  RegisterFrameCon(Tag_Manifestacao_Detalhes, TFrame_ConsuManifestacao_Eventos);
