unit Frame_ConPessoas_Fornecedor;
...
type
  TFrame_ConsuPessoas_Fornecedor = class(TFrame_ConsuPessoas_Mestre)
...
var
  Frame_ConsuPessoas_Fornecedor: TFrame_ConsuPessoas_Fornecedor;
...
procedure TFrame_ConsuPessoas_Fornecedor.WREventosConsultaGetFiltrosConsulta(Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('P.IS_FOR = ''S'' ');
end;

initialization
  RegisterClass(TFrame_ConsuPessoas_Fornecedor);
  RegisterFrameCon(Tag_Pessoas_Fornecedor, TFrame_ConsuPessoas_Fornecedor);
