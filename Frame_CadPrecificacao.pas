...
uses
  ...
  cxButtonEdit, Frame_ConProduto_Servico, cxLabel, FireDAC.Phys.IBWrapper,
...
type
  TFrmPrecificacao = class(TFrmCad_Frame)
...
procedure TFrmPrecificacao.btnConfirmarClick(Sender: TdxTileControlItem);
begin
  try
    inherited;
  except
...
procedure TFrmPrecificacao.btnMaoDeObraClick(Sender: TObject);
begin
  inherited;
  GrupoMaoDeObra.MakeVisible;
end;

procedure TFrmPrecificacao.btnNovoClick(Sender: TdxTileControlItem);
begin
  inherited;
...
procedure TFrmPrecificacao.CadastroAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TFrmPrecificacao.CadastroAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TFrmPrecificacao.CadastroAfterPost(DataSet: TDataSet);
begin
  inherited;
  AtualizaAberturaCompetencia;
end;

procedure TFrmPrecificacao.AtualizaAberturaCompetencia;
begin
...
procedure TFrmPrecificacao.CadastroBeforeClose(DataSet: TDataSet);
begin
  inherited;
...
procedure TFrmPrecificacao.cbCompetenciaPropertiesEditValueChanged(
  Sender: TObject);
var
...
procedure TFrmPrecificacao.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrmPrecificacao.FuncionarioSalarioAfterOpen(DataSet: TDataSet);
var
...
procedure TFrmPrecificacao.FuncionarioSalarioAfterPost(DataSet: TDataSet);
begin
  inherited;
...
procedure TFrmPrecificacao.FuncionarioSalarioBeforeClose(DataSet: TDataSet);
begin
  inherited;
  PessoaSelecionada.Close;
end;

procedure TFrmPrecificacao.FuncionarioSalarioBeforeEdit(DataSet: TDataSet);
begin
  inherited;
  VerificaSePodeAlteraDataSet;
end;

procedure TFrmPrecificacao.FuncionarioSalarioBeforePost(DataSet: TDataSet);
begin
  inherited;
  CalculaValores(FuncionarioSalario, 'ano');
end;

procedure TFrmPrecificacao.GridFuncaoDBTableView1CellClick(
...
procedure TFrmPrecificacao.GridFuncaoDBTableView1CODSERVICO_VINCULADOÎProdutoPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  ACodProduto: string;
begin
...
procedure TFrmPrecificacao.GridFuncaoDBTableView1Column1PropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  ShowMessage('Editar');
...
procedure TFrmPrecificacao.GridFuncaoDBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
  inherited;
...
procedure TFrmPrecificacao.GridFuncaoDBTableView1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmPrecificacao.GridFuncaoDBTableView1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
...
procedure TFrmPrecificacao.GridFuncaoDBTableView1TOTAL_ENCARGOSPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
...
procedure TFrmPrecificacao.GridSubGridViewCODSERVICO_VINCULADOPropertiesStartClick(
  Sender: TObject);
var
  ACodProduto: String;
begin
...
procedure TFrmPrecificacao.GridSubGridViewDragDrop(Sender, Source: TObject;
  X, Y: Integer);
var
  HT: TcxCustomGridHitTest;
  ACodigo: Variant;
...
procedure TFrmPrecificacao.GridSubGridViewDragOver(Sender, Source: TObject;
...
procedure TFrmPrecificacao.PessoaSelecionadaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  Debug(VarToStr(PessoaSelecionada.RecordCount));
end;

procedure TFrmPrecificacao.PessoaSelecionadaAfterPost(DataSet: TDataSet);
begin
  inherited;
//  UCHist_Cadastro.MensagemHistorico.Add('Alterado Funcionario ' + DataSet.FieldByName('DESCRICAO').AsString + '.');
end;

procedure TFrmPrecificacao.PessoaSelecionadaBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TFrmPrecificacao.rbTipoRateioClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmPrecificacao.rbTipoRateioPropertiesEditValueChanged(
  Sender: TObject);
begin
  inherited;
...
procedure TFrmPrecificacao.SubGridAfterClose(DataSet: TDataSet);
begin
  inherited;
  Centro_Trabalho.Close;
end;

procedure TFrmPrecificacao.SubGridAfterOpen(DataSet: TDataSet);
begin
  inherited;
  Centro_Trabalho.Open;
end;

procedure TFrmPrecificacao.SubGridBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TFrmPrecificacao.tiCancelarFechamentoClick(
...
procedure TFrmPrecificacao.tiFecharMesClick(Sender: TdxTileControlItem);
var
...
procedure TFrmPrecificacao.UCHist_SeguidorAddHistorico(Sender: TObject;
...
procedure TFrmPrecificacao.WREventosCadastroConfiguracao_Acoes(
  Sender: TObject);
begin
  inherited;
...
procedure TFrmPrecificacao.Centro_TrabalhoBeforeEdit(DataSet: TDataSet);
begin
  inherited;
  VerificaSePodeAlteraDataSet;
end;

procedure TFrmPrecificacao.CurrencyEdit(
...
procedure TFrmPrecificacao.dxLayoutGroup2TabChanged(Sender: TObject);
begin
  inherited;
...
procedure TFrmPrecificacao.btnAcessar_FolhaClick(Sender: TObject);
begin
  inherited;
  CadastroMidChildChave(TFrmFolha_Pagamento, VarArrayOf([FolhaPagamento.FieldByName('CODIGO').AsString, 1]));
end;

procedure TFrmPrecificacao.btnBuscarClick(Sender: TObject);
var
...
procedure TFrmPrecificacao.AbreFuncionarioSalarioOriginal;
begin
  FuncionarioSalario.Close;
...
procedure TFrmPrecificacao.AbreFuncionarioSalarioSemFiltro;
begin
  FuncionarioSalario.Close;
...
procedure TFrmPrecificacao.AgrupaSubGrid(ACampo_Codigo, ACampo_Descricao, SQLSubGrid: String);
begin
...
initialization
  RegisterClass(TFrmPrecificacao);
  RegisterFrameCad(Tag_Precificacao, TFrmPrecificacao);
