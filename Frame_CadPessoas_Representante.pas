unit Frame_CadPessoas_Representante;
...
type
  TFrame_Pessoas_Representante = class(TFrame_Pessoas_Mestre)
  private
...
var
  Frame_Pessoas_Representante: TFrame_Pessoas_Representante;
...
initialization
  RegisterClass(TFrame_Pessoas_Representante);
  RegisterFrameCad(Tag_Pessoas_Representante, TFrame_Pessoas_Representante);
