...
type
  TFrameBI_Compras = class(TPainel_Frame)
...
var
  FrameBI_Compras: TFrameBI_Compras;
...
procedure TFrameBI_Compras.BtnDashBoardButtonOnClick(Sender: TObject);
//Var I : Integer;
//  Achou : Boolean;
begin
...
procedure TFrameBI_Compras.ConsultaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  CriaBotoesDashBoardButton;
end;

procedure TFrameBI_Compras.CriaBotoesDashBoardButton;
var
  AButton: TcxButton;
  I: Integer;
begin
...
procedure TFrameBI_Compras.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrameBI_Compras.WREventosConsultaSQLTrataNomes(Sender: TObject;
  var ASQL: string);
begin
  inherited;
...
initialization
  RegisterFramePainel(Tag_BI_Compras, TFrameBI_Compras);
