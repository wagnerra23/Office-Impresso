...
type
  TFrameBI_Vendas = class(TPainel_Frame)
...
var
  FrameBI_Vendas: TFrameBI_Vendas;
...
procedure TFrameBI_Vendas.BtnDashBoardButtonOnClick(Sender: TObject);
//Var I : Integer;
//  Achou : Boolean;
begin
...
procedure TFrameBI_Vendas.ConsultaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  CriaBotoesDashBoardButton;
end;

procedure TFrameBI_Vendas.CriaBotoesDashBoardButton;
//var
//  AButton: TcxButton;
//  I: Integer;
begin
...
procedure TFrameBI_Vendas.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrameBI_Vendas.WREventosConsultaSQLTrataNomes(Sender: TObject;
  var ASQL: string);
begin
  inherited;
...
initialization
  RegisterFramePainel(Tag_BI_Vendas, TFrameBI_Vendas);
