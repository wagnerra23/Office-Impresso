...
uses
  ...
  cxImageComboBox, cxSchedulerStorage, cxSchedulerCustomControls,
  cxSchedulerDateNavigator, System.Generics.Collections, cxDateNavigator,
  UCHistDataset;

type
  TConsuNF_CST = class(TConsuM)
    ...
    GridConsultaDBTableView1TEM_TRIBUTO: TcxGridDBColumn;
    GridConsultaDBTableView1TEM_BC: TcxGridDBColumn;
    GridConsultaDBTableView1TEM_CALCULO_ICMS: TcxGridDBColumn;
    GridConsultaDBTableView1TEM_ST: TcxGridDBColumn;
    GridConsultaDBTableView1TEM_REDUCAO: TcxGridDBColumn;
    GridConsultaDBTableView1TEM_BASE: TcxGridDBColumn;
