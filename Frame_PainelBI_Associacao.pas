unit Frame_PainelBI_Associacao;
...
type
  TFrameBI_Associacao = class(TPainel_Frame)
...
var
  FrameBI_Associacao: TFrameBI_Associacao;
...
procedure TFrameBI_Associacao.BtnDashBoardButtonOnClick(Sender: TObject);
//Var I : Integer;
//  Achou : Boolean;
begin
...
procedure TFrameBI_Associacao.ConsultaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  CriaBotoesDashBoardButton;
end;

procedure TFrameBI_Associacao.CriaBotoesDashBoardButton;
var
  AButton: TcxButton;
  I: Integer;
begin
...
procedure TFrameBI_Associacao.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrameBI_Associacao.WREventosConsultaSQLTrataNomes(Sender: TObject;
  var ASQL: string);
begin
  inherited;
...
initialization
  RegisterFramePainel(Tag_BI_Associacao, TFrameBI_Associacao);
