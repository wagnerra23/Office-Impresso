unit Frame_PainelBI_Faturamento;
...
type
  TFrameBI_Faturamento = class(TPainel_Frame)
...
var
  FrameBI_Faturamento: TFrameBI_Faturamento;
...
procedure TFrameBI_Faturamento.BtnDashBoardButtonOnClick(Sender: TObject);
//Var I : Integer;
//  Achou : Boolean;
begin
...
procedure TFrameBI_Faturamento.ConsultaAfterOpen(DataSet: TDataSet);
begin
  inherited;
  CriaBotoesDashBoardButton;
end;

procedure TFrameBI_Faturamento.CriaBotoesDashBoardButton;
var
  AButton: TcxButton;
  I: Integer;
begin
...
procedure TFrameBI_Faturamento.FrameEnter(Sender: TObject);
begin
  inherited;
...
procedure TFrameBI_Faturamento.WREventosConsultaSQLTrataNomes(Sender: TObject;
  var ASQL: string);
begin
  inherited;
...
initialization
  RegisterFramePainel(Tag_BI_Faturamento, TFrameBI_Faturamento);
