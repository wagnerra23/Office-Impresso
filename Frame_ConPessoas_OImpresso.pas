unit Frame_ConPessoas_OImpresso;
...
type
  TFrame_ConsuPessoas_OImpresso = class(TFrame_ConsuPessoas_Mestre)
...
var
  Frame_ConsuPessoas_OImpresso: TFrame_ConsuPessoas_OImpresso;
...
procedure TFrame_ConsuPessoas_OImpresso.WREventosConsultaGetFiltrosConsulta(Sender: TObject);
begin
  inherited;
  SQLWhere.AddAnd('P.OIMPRESSO_ATIVO = ''S'' ');
end;

initialization
  RegisterClass(TFrame_ConsuPessoas_OImpresso);
  RegisterFrameCon(Tag_Pessoas_OImpresso, TFrame_ConsuPessoas_OImpresso);
